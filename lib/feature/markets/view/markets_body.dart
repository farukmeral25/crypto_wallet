...
import 'package:crypto_wallet_mobile/feature/markets/view/widget/coin_chart.dart';
import 'package:crypto_wallet_mobile/feature/markets/view/widget/coin_info_bar.dart';
...
class MarketBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MarketCubit, MarketState>(
      bloc: cubit,
      builder: (context, state) => AppWidgetStateBuilder.none(
